...
const HeroSlider = () => {
  ...
  return (
    <section className="relative w-full h-[450px] md:h-[700px] overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-2xl mb-10 md:mb-16 border border-white/10 group bg-black">
      {/* Slides */}
